...
from .video_prompt_generator import (
    ...
    NODE_CLASS_MAPPINGS as VIDEO_PROMPT_GENERATOR_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as VIDEO_PROMPT_GENERATOR_DISPLAY_MAPPINGS
)
NODE_CLASS_MAPPINGS = {
    **FINAL_FRAME_SELECTOR_MAPPINGS,
    **VIDEO_MERGE_MAPPINGS,
    **YOUTUBE_VIDEO_DOWNLOADER_MAPPINGS,
    **VIDEO_PROMPT_GENERATOR_MAPPINGS
}
NODE_DISPLAY_NAME_MAPPINGS = {
    **FINAL_FRAME_SELECTOR_DISPLAY_MAPPINGS,
    **VIDEO_MERGE_DISPLAY_MAPPINGS,
    **YOUTUBE_VIDEO_DOWNLOADER_DISPLAY_MAPPINGS,
    **VIDEO_PROMPT_GENERATOR_DISPLAY_MAPPINGS
}